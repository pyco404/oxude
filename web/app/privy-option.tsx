...
export function PrivyOption({ label = "Email or X", menu = false }: { label?: string; menu?: boolean }) {
  ...
  return (
    <button
      ...
      className="rounded-panel mt-2 w-full border border-line px-3 py-2 text-[13px] text-text hover:border-accent disabled:text-muted disabled:hover:border-line"
    >
